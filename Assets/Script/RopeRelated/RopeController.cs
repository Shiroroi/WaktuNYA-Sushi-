...
public class RopeController : MonoBehaviour
{
    ...
    [SerializeField] private float _targetFinalGravity;
    [SerializeField] private float _targetFinalMass;
    ...
    void RopeThrow()
    {
        ...
        {
            _hitInformation.collider.GetComponent<FireballBehaviour>().canEndDetection = true;
        }
    ...
    public void InitializePlayerAndTarget()
    {
        ...
        if (targetRigidbody != null)
        {
            ...
            targetRigidbody.gravityScale = _targetFinalGravity;
            
            targetRigidbody.mass = _targetFinalMass;
